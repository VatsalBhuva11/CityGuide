...
function BlogInfo(blog ) {
    console.log(blog);
    const {id,blogtime,description,author,title} = blog.blog;
  ...
  return (
              ...
              <div class="flex justify-between items-center">
                  ...
                  <Link to={`/blog/${id}`} class="inline-flex items-center font-medium text-white dark:text-primary-500 hover:underline">
                      Read more
