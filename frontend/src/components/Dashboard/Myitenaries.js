...
<div class="   bg-[#321735] bg-opacity-30 border border-gray-200 rounded-lg shadow ">
    ...
    <div class="px-5">
        <p class="mb-3 font-normal text-white ">Duration: 2 Sep - 5 Sep</p>
        <p class="mb-3 font-normal text-white ">Created at: 24 Aug </p>
        <p class="mb-3 font-normal text-white ">Last Modified: 1 Sep</p>
        <p class="mb-3 font-normal text-white "></p>
        <a href="#" class="inline-flex items-center px-3 py-2 mb-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800  focus:outline-none">
            Read more
